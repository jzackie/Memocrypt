  ...
  return (
    <div style={{ minHeight: '100vh', background: 'radial-gradient(ellipse at center, #101010 60%, #000 100%)', color: '#ededed', fontFamily: 'var(--font-sans)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', position: 'relative' }}>
      ...
      <div style={{
        ...
        <button onClick={handleCopy} style={{ width: '100%', background: 'none', border: 'none', color: '#39ff14', fontWeight: 700, fontSize: 18, marginBottom: 10, cursor: 'pointer', padding: 10, borderRadius: 8, transition: 'background 0.2s', outline: 'none' }}>Copy</button>
        <button onClick={handleDownload} style={{ width: '100%', background: 'none', border: 'none', color: '#39ff14', fontWeight: 700, fontSize: 18, marginBottom: 30, cursor: 'pointer', padding: 10, borderRadius: 8, transition: 'background 0.2s', outline: 'none' }}>Download</button>
        ...
        <button onClick={handleContinue} style={{ width: '100%', background: 'none', border: '1.5px solid #39ff14', color: '#39ff14', fontWeight: 600, fontSize: 17, borderRadius: 10, marginBottom: 12, padding: 12, cursor: 'pointer', transition: 'background 0.2s', marginTop: 8 }}>Continue to App</button>
